...
{
	public class POMABlockchainSendManyTester : RpcRequestTester<DTOs.Transaction> // TODO: add a way to test method that need an open wallet
	{
		[Fact]
		...
		{
			var sendMany = new POMABlockchainSendMany(client);
