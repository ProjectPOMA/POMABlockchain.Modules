...
using POMABlockchain.Modules.KeyPairs.Cryptography;
using POMABlockchain.Modules.NVM;
using ECPoint = POMABlockchain.Modules.KeyPairs.Cryptography.ECC.ECPoint;
...
namespace POMABlockchain.Modules.KeyPairs
{
    public static class Helper
    {
        ...
        /// <summary>
        /// Converts the script hash to a POMABlockchain Address
        /// </summary>
