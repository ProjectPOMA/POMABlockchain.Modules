...
namespace POMABlockchain.Modules.NEP6.Models
{
    public class Contract
    {
        ...
        /// <summary>
        /// An array of Parameter objects which describe the details of each parameter in the contract function.
        /// For more information about Parameter object, see the descriptions in NEP-3: <see href="https://github.com/POMABlockchain-project/proposals/pull/12">POMABlockchainContract ABI</see>
        /// </summary>
