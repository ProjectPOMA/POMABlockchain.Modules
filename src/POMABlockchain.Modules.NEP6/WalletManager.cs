...
namespace POMABlockchain.Modules.NEP6
{
    ...
    public class WalletManager
    {
        ...
        private IPOMABlockchainscanService _restService;
        ...
        public WalletManager(IPOMABlockchainscanService restService, IClient client, Wallet wallet = null)
        {
        ...
        public void ChangeApiEndPoints(IClient client, IPOMABlockchainscanService restService)
        {
            _client = client;
            _restService = restService;
        ...
        {
            _client = client;
            _restService = new POMABlockchainScanRestService(restUrl);
            ChangeAccountsClient();
        }
