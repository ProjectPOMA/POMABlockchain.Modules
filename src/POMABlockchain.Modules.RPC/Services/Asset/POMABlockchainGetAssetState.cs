...
namespace POMABlockchain.Modules.RPC.Services.Asset
{
    /// <Summary>
    ///     getassetstate 
    ...
    /// }
    /// </Summary>
    public class POMABlockchainGetAssetState : RpcRequestResponseHandler<AssetState>
    {
        public POMABlockchainGetAssetState(IClient client) : base(client, ApiMethods.getassetstate.ToString())
        {
        }
