...
namespace POMABlockchain.Modules.RPC.Services.Transactions
{
    ...
    ///     }
    /// </Summary>
    public class POMABlockchainGetRawTransactionSerialized : RpcRequestResponseHandler<string>
    {
        public POMABlockchainGetRawTransactionSerialized(IClient client) : base(client, ApiMethods.getrawtransaction.ToString())
        {
        }
