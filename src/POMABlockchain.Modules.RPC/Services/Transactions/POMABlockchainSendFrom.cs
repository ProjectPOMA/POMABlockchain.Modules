...
namespace POMABlockchain.Modules.RPC.Services.Transactions
{
	...
	///		<note type="important"> You need to open the wallet in the POMABlockchain-CLI node before executing this command.</note>
	///		
	///     Parameters
	...
	/// }
	/// </summary>
	public class POMABlockchainSendFrom : RpcRequestResponseHandler<DTOs.Transaction>
	{
		public POMABlockchainSendFrom(IClient client) : base(client, ApiMethods.sendfrom.ToString())
		{
		}
