...
namespace POMABlockchain.Modules.RPC.Services.Transactions
{
	...
	/// }
	/// </summary>
	public class POMABlockchainSendMany : RpcRequestResponseHandler<DTOs.Transaction>
	{
		public POMABlockchainSendMany(IClient client) : base(client, ApiMethods.sendmany.ToString())
		{
		}
