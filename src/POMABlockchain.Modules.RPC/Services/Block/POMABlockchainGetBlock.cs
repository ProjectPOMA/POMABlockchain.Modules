...
namespace POMABlockchain.Modules.RPC.Services.Block
{
    ...
    /// }
    /// </Summary>
    public class POMABlockchainGetBlock : RpcRequestResponseHandler<DTOs.Block>
    {
        public POMABlockchainGetBlock(IClient client) : base(client, ApiMethods.getblock.ToString())
        {
        }
