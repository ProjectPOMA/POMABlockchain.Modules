...
namespace POMABlockchain.Modules.RPC.Services.Block
{
    ...
    ///     }
    /// </Summary>
    public class POMABlockchainGetBlockHash : RpcRequestResponseHandler<string>
    {
        public POMABlockchainGetBlockHash(IClient client) : base(client, ApiMethods.getblockhash.ToString())
        {
        }
