...
namespace POMABlockchain.Modules.RPC.Services.Block
{
    ...
    ///     }
    /// </Summary>
    public class POMABlockchainGetBlockSerialized : RpcRequestResponseHandler<string>
    {
        public POMABlockchainGetBlockSerialized(IClient client) : base(client, ApiMethods.getblock.ToString())
        {
        }
