...
namespace POMABlockchain.Modules.RPC.Services.Node
{
    ...
    /// }
    /// </Summary>
    public class POMABlockchainGetPeers : GenericRpcRequestResponseHandlerNoParam<DTOs.Peers>
    {
        public POMABlockchainGetPeers(IClient client) : base(client, ApiMethods.getpeers.ToString())
        {
        }
    }
}