...
namespace POMABlockchain.Modules.RPC.Services.Node
{
    /// <Summary>
    ///     getvalidators    
    ///     Get current POMABlockchain consensus node information and voting conditions.
    /// 
    ///     Parameters
    ///     none
    /// 
    ...
    ///     }
    /// </Summary>
    public class POMABlockchainGetValidators : GenericRpcRequestResponseHandlerNoParam<List<DTOs.Validator>>
    {
        public POMABlockchainGetValidators(IClient client) : base(client, ApiMethods.getvalidators.ToString())
        {
        }
    }
}
