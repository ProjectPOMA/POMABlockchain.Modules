...
namespace POMABlockchain.Modules.RPC.Services.Account
{
	...
	///     <note type="important">
	///      You need to open the wallet in the POMABlockchain-CLI node before you execute this command.
	///     </note>
	/// 
	///     Parameters
	...
	///		}
	/// </Summary>   
	public class POMABlockchainDumpPrivateKey : RpcRequestResponseHandler<string>
	{
		public POMABlockchainDumpPrivateKey(IClient client) : base(client, ApiMethods.dumpprivkey.ToString())
		{
		}
