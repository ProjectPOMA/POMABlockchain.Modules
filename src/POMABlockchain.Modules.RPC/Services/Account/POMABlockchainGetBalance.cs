...
namespace POMABlockchain.Modules.RPC.Services.Account
{
    ...
    /// </summary>
    /// 
    public class POMABlockchainGetBalance : RpcRequestResponseHandler<DTOs.WalletBalance>
    {
        public POMABlockchainGetBalance(IClient client) : base(client, ApiMethods.getbalance.ToString())
        {
        }
