...
namespace POMABlockchain.Modules.RPC.Services.Contract
{
	...
	/// }
	/// </Summary>   
	public class POMABlockchainInvokeFunction : RpcRequestResponseHandler<DTOs.Invoke>
	{
		public POMABlockchainInvokeFunction(IClient client) : base(client, ApiMethods.invokefunction.ToString())
		{
		}
