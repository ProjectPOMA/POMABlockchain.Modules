...
namespace POMABlockchain.Modules.RPC.Services.Contract
{
	...
	///     }
	/// </Summary>
	public class POMABlockchainInvokeScript : RpcRequestResponseHandler<DTOs.Invoke>
	{
		public POMABlockchainInvokeScript(IClient client) : base(client, ApiMethods.invokescript.ToString())
		{
		}
