...
namespace POMABlockchain.Modules.RPC.Services.Contract
{
    ...
    ///     }
    /// </Summary>
    public class POMABlockchainGetStorage : RpcRequestResponseHandler<string>
    {
        public POMABlockchainGetStorage(IClient client) : base(client, ApiMethods.getstorage.ToString())
        {
        }
